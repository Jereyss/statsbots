        ...
        try {
            ...
            if (joinedDoc && joinedDoc.inviterID) {
                ...
                if (inviterDoc) {
                    ...
                    if (isFake) {
                        if (inviterDoc.inviteStats.fake > 0) inviterDoc.inviteStats.fake -= 1;
                    } else {
                        if (inviterDoc.inviteStats.regular > 0) inviterDoc.inviteStats.regular -= 1;
            ...
            console.error("[Invite Tracker] guildMemberRemove hatasi:", err);
        }
    }
};
